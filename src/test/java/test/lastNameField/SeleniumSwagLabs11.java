...
//Test case when user enter 25 or more characters for last name

public class SeleniumSwagLabs11 {
    WebDriver driver;
    String title;
    WebElement element;
    ...
    public void continueOrder() throws InterruptedException {
        ...
        String lastName = "Doeeeefagagagagadgadgagraga";
        ...
        Assert.assertEquals(actual, expected, "Last name can't have more than 25 characters");
    }
}
