...
//Test case when user enter number with less than 5 digits for zip

public class SeleniumSwagLabs3 {
    WebDriver driver;
    String title;
    WebElement element;
    ...
    public void continueOrder() throws InterruptedException {
        ...
        Assert.assertEquals(expected, actual, "Zip can't have less than 5 digits");
    }
}
